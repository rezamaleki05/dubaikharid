                ...
                <div className={styles.detailsCollapsibleBody}>
                  <div className={styles.customerAvatarBox}>
                    <img
                      ...
                      alt={selectedLead.customerName || 'مشتری'}
              ...
              <div className={styles.detailsCollapsibleBody}>
                {Array.isArray(selectedLead.items) && selectedLead.items.length > 0 ? (
                  ...
                  <div className={styles.detailsProductItem}>
                    <img
                      src={selectedLead.img || 'https://images.unsplash.com/photo-1505740420928-5e560c06d30e?w=80&q=80'}
                      alt={selectedLead.productName || 'محصول'}
                      className={styles.detailsProductImg}
                    />
                    <div className={styles.detailsProductInfo}>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td style={{ textAlign: 'left', fontWeight: 'bold', color: '#fff' }}>
                        {fmtToman(selectedLead.priceDetails?.product ?? Number(selectedLead.totalToman || 0) * 0.82)} تومان
                      </td>
                    </tr>
                    <tr>
                      <td>هزینه ارسال هوایی به ایران</td>
                      <td style={{ textAlign: 'left', fontWeight: 'bold', color: '#fff' }}>
                        {fmtToman(selectedLead.priceDetails?.shipping ?? Number(selectedLead.totalToman || 0) * 0.08)} تومان
                      </td>
                    </tr>
                    <tr>
                      <td>کارمزد سرویس دبی‌خرید</td>
                      <td style={{ textAlign: 'left', fontWeight: 'bold', color: '#fff' }}>
                        {fmtToman(selectedLead.priceDetails?.commission ?? Number(selectedLead.totalToman || 0) * 0.10)} تومان
                      </td>
                    </tr>
                    <tr>
