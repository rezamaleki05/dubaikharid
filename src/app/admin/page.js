...
export default function AdminPanel() {
  ...
  useEffect(() => {
    // One-time clear of mock seed data
    const hasClearedMockData = localStorage.getItem('dubaiKharidHasClearedMockData3');
    if (!hasClearedMockData) {
      localStorage.removeItem('dubaiKharidCustomers');
      localStorage.removeItem('dubaiKharidLeads');
      localStorage.removeItem('dubaiKharidAdminProducts');
      localStorage.removeItem('dubaiKharidWarehouseProducts');
      localStorage.removeItem('dubaiKharidPayments');
      localStorage.removeItem('dubaiKharidShipments');
      localStorage.setItem('dubaiKharidHasClearedMockData3', 'true');
    }
