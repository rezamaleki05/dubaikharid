...
export default function LoginPage() {
  ...
  const { login, register, triggerGoogleLogin, googleAvailable, isLoggedIn, authLoading } = useAuth();
      ...
      <main className={styles.mainContainer} dir="rtl">
        <div className={styles.authCard}>
          ...
          <form className={styles.form} onSubmit={handleSubmit} noValidate>
            ...
            {/* Social Logins */}
            {googleAvailable && <div className={styles.divider}>یا</div>}

            {googleAvailable && <div className={styles.socialButtons}>
              <button 
                type="button" 
