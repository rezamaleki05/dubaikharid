...
function WomenContent() {
  ...
  const availableBrands = Array.from(new Set(womenProducts.map(p => p.brand)));
    ...
    <div className={styles.pageWrapper}>
      ...
      <main className={styles.mainContainer} dir="rtl">
        ...
        <div className={styles.heroSection}>
          <h1 className={styles.title}>مجموعه زنانه دبی خرید</h1>
          <p className={styles.subtitle}>خرید مستقیم لباس، شلوار، کفش و روسری اصل برندهای لوکس از دبی با ارسال سریع</p>
        </div>
